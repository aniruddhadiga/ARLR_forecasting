...
setwd("/Users/vsriniv/Documents/Research/Github/influenza-models-forecasting/uvamodels")
...
files <- list.files(path="UVA_FluX_models_2018-19/", pattern="*.csv", full.names=FALSE, recursive=TRUE)
